...
| [margelet_beta.apk](https://github.com/narezany/margelet/raw/apk/margelet_beta.apk) | «Пререлиз 1.0» на проверку: version.json на него не указывает, сам никому не приедет. Margy, стена, баннеры, хуки методов |
